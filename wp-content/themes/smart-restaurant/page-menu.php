...
<main class="main-content">
    <?php smart_restaurant_breadcrumbs(); ?>
            ...
            <div class="accordion" id="accordionExample">
                ...
                <?php if (!empty($pizza_categories) && !is_wp_error($pizza_categories)) :
                    foreach ($pizza_categories as $category) :
                        $pizzas = smart_restaurant_get_pizzas($category->slug);
                                                ...
                                                <div class="menu-item">
                                                    <div class="menu-item-info">
                                                        ...
                                                        <p class="menu-item-ingredients">
                                                            <?php echo esc_html(smart_restaurant_get_pizza_ingredients(get_the_ID())); ?>
                                                        </p>
                                                    </div>
                                                    <div class="menu-item-price">
                                                        <?php echo smart_restaurant_get_pizza_price(get_the_ID()); ?>
                                                    </div>
                                                </div>
                                            <?php endwhile; ?>
                                        </div>
