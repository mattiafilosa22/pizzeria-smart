...
<section class="section" id="menu">
  <div class="container">
    ...
    <div class="grid grid-3 fade-in-up">
      <?php
      $special_pizzas = smart_restaurant_get_pizzas('', 3, true);
      ...
      ?>
          <div class="card">
            ...
            <div class="card-content">
              ...
              <p class="card-ingredients"><strong>Ingredienti:</strong> <?php echo esc_html(smart_restaurant_get_pizza_ingredients(get_the_ID())); ?></p>
              <div style="display: flex; justify-content: space-between; align-items: center; margin-top: 1rem;">
                <span class="card-price"><?php echo smart_restaurant_get_pizza_price(get_the_ID()); ?></span>
