# Istruzioni per l'installazione del tema Smart Restaurant

## Installazione

1. **Copia i file del tema**
   - Assicurati che tutti i file siano nella cartella `/wp-content/themes/smart-restaurant/`

2. **Attivazione del tema**
   - Vai su **Aspetto > Temi** nel pannello WordPress
   - Seleziona "Smart Restaurant" e clicca "Attiva"
...
- Per cambiare font, modifica l'URL in `smart_restaurant_scripts()`
...
Tema sviluppato specificamente per Smart Restaurant.
