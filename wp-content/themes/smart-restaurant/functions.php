...
function pizzeria_egidio_custom_post_types()
{
    ...
    register_post_type('piatto', array(
        'labels' => array(
            ...
            'search_items'  => __('Cerca piatto', 'smart-restaurant'),
        ),
        'public'        => true,
        'has_archive'   => false,
    ...
    register_taxonomy('pizza_category', 'pizza', array(
        'labels' => array(
            'name'          => __('Categorie Pizza', 'smart-restaurant'),
            'singular_name' => __('Categoria Pizza', 'smart-restaurant'),
        ),
        'public'       => true,
        'hierarchical' => true,
        'show_in_rest' => true,
...
function pizzeria_egidio_add_pizza_metaboxes()
{
    add_meta_box(
        'pizza_details',
        __('Dettagli Pizza', 'smart-restaurant'),
...
?>
    <table class="form-table">
        ...
        <tr>
            <th><label for="pizza_is_special"><?php _e('Pizza Speciale', 'smart-restaurant'); ?></label></th>
